...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.comboBox.currentIndexChanged.connect(self.onPushButtonComboBoxClicked)  # TODO подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
    ...
    def onPushButtonComboBoxClicked(self) -> None:
        ...
        Также используется при отображении изменения элемента ComboBox
    ...
    def onPushButtonSpinBoxClicked(self) -> None:
        ...
        Также используется при отображении изменения в spinBox
    ...
    def onPushButtonDateTimeEditClicked(self) -> None:
        ...
        Также используется при отображении изменения даты и времени
